...
export default function UnlockNoteDilogue({title, password, setPassword, onOkPress, onCancelPress, visible}) {
        ...
        <Dilogue transparentBackColor={"#0008"} dilogueVisible={visible} closeDilogue={onCancelPress} dilogueBackground={colors.backOne} cancellable={true}>
            ...
            <View style={styles.buttonsView}>
                ...
                <TouchableOpacity style={{padding: 15}} onPress={onOkPress}>
                    <Text style={[styles.btnTxt,{color: colors.primaryColor}]}>Unlock note</Text>
                </TouchableOpacity>
            </View>
        </Dilogue>
    )
